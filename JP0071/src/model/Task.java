...
public class Task {
    ...
    public String display() {
        ...
        System.out.printf("%-5s %-10s %-10s %-10s %-5s %-5s %-5s %-5s\n",
                "ID", "Name", "Task Type", "Date", "From", "To", "Assigne", "Reviewer");

        return String.format("%-5s %-10s %-10s %-10s %-5s %-5s %-5s %-5s\n",
                id, requirementName, getTaskTypeString(taskTypeID), stringDate, planFrom,
